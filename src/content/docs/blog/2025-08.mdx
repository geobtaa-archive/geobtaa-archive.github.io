...
import ProgramUpdate from 'src/components/ProgramUpdate.astro';
...
<CenterLayout>
![New members](@images/nestel-whyte-rohl.png)
...
<CardGrid class="kpi-grid">
  <Card class="kpi-card">
    <p class="kpi-label">Visitors</p>
    <p class="kpi-value">6,097 </p>
  </Card>

  <Card class="kpi-card">
    <p class="kpi-label">Visits</p>
    <p class="kpi-value">7,067 </p>
  </Card>

  <Card class="kpi-card">
    <p class="kpi-label">Downloads</p>
    <p class="kpi-value">442</p>
  </Card>

  <Card class="kpi-card">
    <p class="kpi-label">Outlinks</p>
    <p class="kpi-value">1,790 </p>
  </Card>

  <Card class="kpi-card">
    <p class="kpi-label">Visits with download</p>
    <p class="kpi-value">6.25%</p>
  </Card>

  <Card class="kpi-card">
    <p class="kpi-label">Visits with outlink</p>
    <p class="kpi-value">25.33%</p>
  </Card>

  <Card class="kpi-card">
    <p class="kpi-label">Number of searches</p>
    <p class="kpi-value">1,365</p>
  </Card>

  <Card class="kpi-card">
    <p class="kpi-label">Search keywords</p>
    <p class="kpi-value">467</p>
  </Card>
</CardGrid>
