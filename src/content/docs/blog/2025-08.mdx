...
layout: src/content/docs/blog/_layouts/BlogPost.astro
cover:
...
<Card title="Geodata Collection Workgroup">
...
<Card title="Service Model Collaboration Workgroup">
...
<Card title="Geospatial Data Citation Workgroup">
