...
date: 2025-09-04
excerpt: Welcome to Our New GIN Members! We’re excited to welcome three new members to the Big Ten Academic Alliance Geospatial Information Network.
cover:
  alt: Nestel, Whyte, and Rohl headshots
  image: ../../../assets/images/nestel-whyte-rohl.png
tags:
  - Program Updates
...
<Tabs>
  <TabItem label="TECHnology">Did not meet as all committee work was wrapped in June.</TabItem>
  <TabItem label="Community Engagement">New committee members met to confirm date/time, determine representative for Coordination Cmte, and finalize posting of Geoportal demo playlist.</TabItem>
  <TabItem label="Knowledge">New committee members met to confirm date/time, determine representative for Coordination Cmte, and to review the charter.</TabItem>
  <TabItem label="Coordination">Did not meet.</TabItem>
...
<Tabs>
  ...
  <TabItem label="Geodata Collection Workgroup">
  ...
  <TabItem label="Service Model Collaboration Workgroup">
  ...
  <TabItem label="Data Citation Workgroup">
...
<Card title = "Unique visitors by month">
![](@images/2025-08-monthly-users.png)
</Card>

<CardGrid>

<Card title = "This month by the numbers">
...
<Card title = "Top internal keyword searches">
...
**Total records as of September 1, 2025:** ==109,345== 
