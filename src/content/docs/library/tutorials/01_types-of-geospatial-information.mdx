...
import vectorDataTypes from '/src/assets/images/vector-data.png';


<Slideshow>
**Purpose**: This tutorial is designed to introduce you different types of geospatial information that are usually used in GIS and can be found from geospatial data portals such as the BTAA Geoportal.
...
![Raster Two Types](@images/raster-two-types.png)Continuous and Categorical Data *Used by permission of Paul Bolstad, GIS Fundamentals
